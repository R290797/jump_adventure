...
class Menu:
    def __init__(self, window, font, colors):
        ...
        self.background_image = pygame.image.load("Resources/Sprites/Sprite-background_3.png")
    ...
    def show_high_scores(self):
        ...
        for i, score in enumerate(self.high_scores):
            score_surface = self.font.render(f"{i + 1}. {score}", True, self.colors["white"])
    ...
    def draw_scroll_bar(self, total_lines, viewport_height, total_scrollable_height):
        ...
        bar_y = self.scroll_position / (total_scrollable_height - viewport_height) * (viewport_height - bar_height)
        pygame.draw.rect(self.window, (169, 169, 169), (self.window.get_width() - 20, 140 + bar_y, 10, bar_height))
